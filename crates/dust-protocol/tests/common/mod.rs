...
use dust_protocol::types::{
    Angle, BitSet, BoundedString, ChatVisibility, FixedBitSet, Identifier, MainHand,
    NextState, Position, PrefixedBytes, ResourcePackResult, RestOfPacket, Uuid, VarInt,
};
...
pub fn corpus() -> Vec<Frame> {
    ...
    push!(handshake::serverbound, Handshake, Serverbound, handshake::serverbound::Intention {
    ...
    push!(status::clientbound, Status, Clientbound, status::clientbound::StatusResponse {
        json: s(r#"{"description":"x"}"#),
    });
    push!(status::clientbound, Status, Clientbound, status::clientbound::PongResponse { payload: -9 });
    push!(status::serverbound, Status, Serverbound, status::serverbound::StatusRequest {});
    push!(status::serverbound, Status, Serverbound, status::serverbound::PingRequest {
        payload: 81985529216486895
    });

    push!(login::clientbound, Login, Clientbound, login::clientbound::LoginDisconnect {
        reason: JsonTextComponent(s(r#"{"text":"no"}"#)),
    });
    push!(login::clientbound, Login, Clientbound, login::clientbound::Hello {
        server_id: s(""),
        public_key: PrefixedBytes(vec![1, 2, 3]),
        verify_token: PrefixedBytes(vec![4, 5, 6, 7]),
        should_authenticate: true,
    });
    push!(login::clientbound, Login, Clientbound, login::clientbound::GameProfile {
        uuid: Uuid(0x0123_4567_89ab_cdef_0123_4567_89ab_cdef),
        username: s("Notch"),
        properties: vec![
            ProfileProperty { name: s("textures"), value: s("base64"), signature: Some(s("sig")) },
            ProfileProperty { name: s("unsigned"), value: s("value"), signature: None },
        ],
        strict_error_handling: true,
    });
    push!(login::clientbound, Login, Clientbound, login::clientbound::LoginCompression {
        threshold: VarInt(256)
    });
    push!(login::clientbound, Login, Clientbound, login::clientbound::CustomQuery {
        message_id: VarInt(7),
        channel: id("fabric:hello"),
        data: RestOfPacket(vec![9, 9, 9]),
    });
    push!(login::clientbound, Login, Clientbound, login::clientbound::CookieRequest {
        key: id("dust:session")
    });

    push!(login::serverbound, Login, Serverbound, login::serverbound::Hello {
        name: s("Notch"),
        profile_id: Uuid(1),
    });
    push!(login::serverbound, Login, Serverbound, login::serverbound::Key {
        shared_secret: PrefixedBytes(vec![1; 16]),
        verify_token: PrefixedBytes(vec![2; 4]),
    });
    push!(login::serverbound, Login, Serverbound, login::serverbound::CustomQueryAnswer {
        message_id: VarInt(7),
    ...
    push!(login::serverbound, Login, Serverbound, login::serverbound::LoginAcknowledged {});
    push!(login::serverbound, Login, Serverbound, login::serverbound::CookieResponse {
        key: id("dust:session"),
        payload: Some(PrefixedBytes(vec![3, 3, 3])),
    });

    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::CookieRequest { key: id("dust:c") });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::CustomPayload {
        channel: id("minecraft:brand"),
        data: RestOfPacket(b"\x04Dust".to_vec()),
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::Disconnect {
        reason: TextComponent(some_nbt()),
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::FinishConfiguration {});
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::KeepAlive { id: -1 });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::Ping { id: -2 });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::ResetChat {});
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::RegistryData {
        registry_id: id("minecraft:dimension_type"),
        entries: vec![
            RegistryEntry { entry_id: id("minecraft:overworld"), data: Some(some_nbt()) },
            RegistryEntry { entry_id: id("minecraft:the_nether"), data: None },
        ],
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::ResourcePackPop {
        uuid: Some(Uuid(5))
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::ResourcePackPush {
        uuid: Uuid(6),
    ...
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::StoreCookie {
        key: id("dust:c"),
        payload: PrefixedBytes(vec![1, 2, 3]),
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::Transfer {
        host: s("elsewhere.example"),
        port: VarInt(25565),
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::UpdateEnabledFeatures {
        features: vec![id("minecraft:vanilla")],
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::UpdateTags {
        registries: vec![TagRegistry {
            registry: id("minecraft:block"),
            tags: vec![Tag { name: id("minecraft:logs"), entries: vec![VarInt(1), VarInt(2), VarInt(3)] }],
        }],
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::SelectKnownPacks {
        packs: vec![KnownPack { namespace: s("minecraft"), id: s("core"), version: s("1.21.1") }],
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::CustomReportDetails {
        details: vec![ReportDetail { title: s("server"), description: s("Dust") }],
    });
    push!(configuration::clientbound, Configuration, Clientbound, configuration::clientbound::ServerLinks {
        links: vec![
            ServerLink {
    ...
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::ClientInformation {
        locale: s("en_GB"),
        view_distance: 12,
    ...
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::CookieResponse {
        key: id("dust:c"),
        payload: None,
    });
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::CustomPayload {
        channel: id("minecraft:brand"),
        data: RestOfPacket(b"\x06vanilla".to_vec()),
    });
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::FinishConfiguration {});
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::KeepAlive { id: 42 });
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::Pong { id: 43 });
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::ResourcePack {
        uuid: Uuid(6),
        result: ResourcePackResult::Declined,
    });
    push!(configuration::serverbound, Configuration, Serverbound, configuration::serverbound::SelectKnownPacks { packs: vec![] });
...
fn play_frames(out: &mut Vec<Frame>) {
    ...
    out.push(frame!(cb, Play, Clientbound, cb::AddEntity {
        entity_id: VarInt(17),
        uuid: Uuid(0x11),
        kind: VarInt(120),
        x: 8.5,
        ...
        head_yaw: Angle(12),
        data: VarInt(-1),
        velocity: EntityVelocity { x: 100, y: -40, z: 8000 },
    }));
    out.push(frame!(cb, Play, Clientbound, cb::BlockUpdate {
        location: Position::new(-100, -60, 100),
        block_id: VarInt(4044),
    }));
    out.push(frame!(cb, Play, Clientbound, cb::Disconnect {
        reason: dust_protocol::text::Component::text("bye").bold(true),
    }));
    out.push(frame!(cb, Play, Clientbound, cb::LevelChunkWithLight {
        chunk_x: -3,
        chunk_z: 19,
        heightmaps: some_nbt(),
        data: ChunkData(PrefixedBytes(vec![0xAA; 64])),
        block_entities: vec![
            BlockEntity { packed_xz: 0x5A, y: -20, kind: VarInt(7), data: some_nbt() },
            BlockEntity { packed_xz: 0x01, y: 90, kind: VarInt(2), data: Nbt::empty() },
        ],
        light: LightData {
    ...
    out.push(frame!(cb, Play, Clientbound, cb::Login {
        entity_id: 1,
        hardcore: true,
    ...
    out.push(frame!(cb, Play, Clientbound, cb::MoveEntityPosRot {
        entity_id: VarInt(17),
        delta: EntityDelta { x: -300, y: 5, z: 300 },
        yaw: Angle(255),
        pitch: Angle(1),
        on_ground: true,
    }));
    out.push(frame!(cb, Play, Clientbound, cb::MoveEntityPos {
        entity_id: VarInt(18),
        delta: EntityDelta { x: 1, y: -1, z: 4095 },
        on_ground: false,
    }));
    out.push(frame!(cb, Play, Clientbound, cb::MoveEntityRot {
        entity_id: VarInt(19),
        yaw: Angle(128),
        pitch: Angle(254),
        on_ground: true,
    }));
    out.push(frame!(cb, Play, Clientbound, cb::PlayerChatMessage {
        sender: Uuid(0x22),
        index: VarInt(4),
        ...
        previous_messages: vec![
            AcknowledgedMessage { id: VarInt(3), signature: None },
            AcknowledgedMessage { id: VarInt(0), signature: Some(signature) },
        ],
    ...
    out.push(frame!(cb, Play, Clientbound, cb::PlayerAbilities {
        flags: Abilities(Abilities::FLYING | Abilities::ALLOW_FLYING),
        flying_speed: 0.05,
        fov_modifier: 0.1,
    }));
    out.push(frame!(cb, Play, Clientbound, cb::PlayerPosition {
        x: 1.5,
        y: -59.99,
        z: 2.5,
        yaw: 179.5,
    ...
    out.push(frame!(cb, Play, Clientbound, cb::PlayerInfoUpdate {
        body: PlayerInfoBody {
            ...
            entries: vec![
                ...
                PlayerInfoEntry {
                    uuid: Uuid(0x34),
                    profile: Some(ProfileAddition { name: s("Dinnerbone"), properties: vec![] }),
    ...
    out.push(frame!(cb, Play, Clientbound, cb::PlayerInfoRemove {
        uuids: vec![Uuid(0x33), Uuid(0x34)],
    }));
    out.push(frame!(cb, Play, Clientbound, cb::CustomPayload {
        channel: id("minecraft:brand"),
        data: RestOfPacket(b"\x04Dust".to_vec()),
    }));
    out.push(frame!(cb, Play, Clientbound, cb::RemoveEntities {
        entity_ids: vec![VarInt(1), VarInt(2), VarInt(3), VarInt(-9)],
    }));
    out.push(frame!(cb, Play, Clientbound, cb::RotateHead {
        entity_id: VarInt(17),
        head_yaw: Angle(64),
    }));
    out.push(frame!(cb, Play, Clientbound, cb::SectionBlocksUpdate {
    ...
    out.push(frame!(cb, Play, Clientbound, cb::SetCarriedItem { slot: 8 }));
    out.push(frame!(cb, Play, Clientbound, cb::SetEntityData {
        entity_id: VarInt(17),
    ...
    out.push(frame!(cb, Play, Clientbound, cb::SystemChat {
        content: dust_protocol::text::Component::text("welcome").italic(true),
        overlay: false,
    }));
    out.push(frame!(cb, Play, Clientbound, cb::Ping { id: -3 }));
    out.push(frame!(cb, Play, Clientbound, cb::PongResponse { payload: 987654321 }));

    out.push(frame!(sb, Play, Serverbound, sb::TeleportConfirm { teleport_id: VarInt(77) }));
    out.push(frame!(sb, Play, Serverbound, sb::Chat {
    ...
    out.push(frame!(sb, Play, Serverbound, sb::CustomPayload {
        channel: id("dust:hello"),
        data: RestOfPacket(vec![1, 2, 3]),
    }));
    out.push(frame!(sb, Play, Serverbound, sb::KeepAlive { id: i64::MIN + 7 }));
    out.push(frame!(sb, Play, Serverbound, sb::MovePlayerPos {
        x: -30_000_000.0,
        y: -64.0,
        z: 29_999_999.75,
        on_ground: true,
    }));
    out.push(frame!(sb, Play, Serverbound, sb::MovePlayerPosRot {
        x: 0.125,
        y: 320.0,
        z: 0.25,
        yaw: -359.5,
    ...
    out.push(frame!(sb, Play, Serverbound, sb::MovePlayerRot {
        yaw: 359.5,
        pitch: -89.75,
        on_ground: true,
    }));
    out.push(frame!(sb, Play, Serverbound, sb::MovePlayerStatusOnly { on_ground: true }));
    out.push(frame!(sb, Play, Serverbound, sb::Pong { id: i32::MIN }));
    out.push(frame!(sb, Play, Serverbound, sb::PlayerAbilities {
        flags: Abilities(Abilities::FLYING),
    }));
    out.push(frame!(sb, Play, Serverbound, sb::PingRequest { payload: -2 }));
    out.push(frame!(sb, Play, Serverbound, sb::SetCarriedItem { slot: 5 }));
}
